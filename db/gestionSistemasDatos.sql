/******************************************************************************/
/***       Generated by IBExpert 2012.02.21 18/11/2015 10:02:44 a.m.        ***/
/******************************************************************************/
...
INSERT INTO ESTADO_SOFT (ID, ESTADO_SOFT) VALUES (1, 'ANALISIS');
INSERT INTO ESTADO_SOFT (ID, ESTADO_SOFT) VALUES (2, 'DISENO');
INSERT INTO ESTADO_SOFT (ID, ESTADO_SOFT) VALUES (3, 'DESARROLLO');
INSERT INTO ESTADO_SOFT (ID, ESTADO_SOFT) VALUES (4, 'IMPLANTACION');
INSERT INTO ESTADO_SOFT (ID, ESTADO_SOFT) VALUES (5, 'MANTENIMIENTO');
INSERT INTO ESTADO_SOFT (ID, ESTADO_SOFT) VALUES (6, 'DESMANTELADO');

COMMIT WORK;

INSERT INTO ROL (ID, ROL) VALUES (1, 'DESARROLLADOR');
INSERT INTO ROL (ID, ROL) VALUES (2, 'USUARIO');

COMMIT WORK;

INSERT INTO PERSONA (ID, ID_ROL, APELLIDO, NOMBRE, CONTACTO, USUARIO, CONTRASENA) VALUES (1, 1, 'REVERSO', 'SEBASTIAN', 'sheba1989@gmail.com', 'sreverso', 'asdqwe');
INSERT INTO PERSONA (ID, ID_ROL, APELLIDO, NOMBRE, CONTACTO, USUARIO, CONTRASENA) VALUES (2, 1, 'JUAREZ', 'PEDRO', NULL, 'pjuarez', 'asdasd');
INSERT INTO PERSONA (ID, ID_ROL, APELLIDO, NOMBRE, CONTACTO, USUARIO, CONTRASENA) VALUES (3, 2, 'DIAZ', 'MARCOS', NULL, 'mdiaz', '1234');
INSERT INTO PERSONA (ID, ID_ROL, APELLIDO, NOMBRE, CONTACTO, USUARIO, CONTRASENA) VALUES (4, 2, 'RAMOS', 'MANUEL', NULL, 'mramos', 'abcd1234');
INSERT INTO PERSONA (ID, ID_ROL, APELLIDO, NOMBRE, CONTACTO, USUARIO, CONTRASENA) VALUES (5, 1, 'ORTIZ', 'LUIS', NULL, 'lortiz', 'qwert');

COMMIT WORK;

INSERT INTO PROYECTO (ID, ID_PERSONA, ID_ESTADO_SOFT, NOMBRE, DESCRIPCION, FECHA_INICIO, FECHA_ACTUALIZACION) VALUES (2, 5, 2, 'CONTROL DE STOCK', 'Sistema para controlar el stock de una empresa.', '2015-11-18', '2015-11-18');
INSERT INTO PROYECTO (ID, ID_PERSONA, ID_ESTADO_SOFT, NOMBRE, DESCRIPCION, FECHA_INICIO, FECHA_ACTUALIZACION) VALUES (1, 3, 3, 'GESTOR DE PROYECTOS', 'Proyecto para la creacion de un gestor de proyectos colaborativos, principalmente destinados a la creacion de software.', '2015-11-13', '2015-11-18');

COMMIT WORK;

INSERT INTO PEDIDO (ID, ID_PERSONA_SOLIC, ID_PERSONA_RECEP, ID_PROYECTO, NOMBRE, FECHA_SOLICITUD, FECHA_RECEPCION, DESCRIPCION) VALUES (1, 1, 1, NULL, 'NUEVO GESTOR DE PROYECTOS', '2015-10-08', '2015-10-31', 'Se solicita la creación de un gestor de proyectos.  Se necesita que el mismo no solo mantenga los desarrollos de software sino además los recursos de hardware que se puedan utilizar.');
INSERT INTO PEDIDO (ID, ID_PERSONA_SOLIC, ID_PERSONA_RECEP, ID_PROYECTO, NOMBRE, FECHA_SOLICITUD, FECHA_RECEPCION, DESCRIPCION) VALUES (2, 1, 2, NULL, 'NUEVA GESTION DE ALUMNOS', '2015-10-08', '2015-11-12', 'Se necesita un software que permita llevar un control de las materias aprobadas por los alumnos de un colegio secundario.');
INSERT INTO PEDIDO (ID, ID_PERSONA_SOLIC, ID_PERSONA_RECEP, ID_PROYECTO, NOMBRE, FECHA_SOLICITUD, FECHA_RECEPCION, DESCRIPCION) VALUES (3, 3, 5, NULL, 'CONTROL DE STOCK', '2015-11-12', '2015-11-17', 'Sistema para llevar un control de los productos almacenados por la empresa.');
INSERT INTO PEDIDO (ID, ID_PERSONA_SOLIC, ID_PERSONA_RECEP, ID_PROYECTO, NOMBRE, FECHA_SOLICITUD, FECHA_RECEPCION, DESCRIPCION) VALUES (5, 3, 1, NULL, 'PRUEBA DE CONCEPTO', '2015-11-16', '2015-11-16', 'Hola mundo ver2');
INSERT INTO PEDIDO (ID, ID_PERSONA_SOLIC, ID_PERSONA_RECEP, ID_PROYECTO, NOMBRE, FECHA_SOLICITUD, FECHA_RECEPCION, DESCRIPCION) VALUES (6, 5, NULL, NULL, 'PROGRAMA PARA DIG', '2015-11-17', NULL, 'Programa ejemplo para Diseno de Interfaz Grafica');

COMMIT WORK;

INSERT INTO VERSION_PROY (ID, ID_PROYECTO, ID_PERSONA, VERSION_MAYOR, VERSION_MENOR, FECHA_ACTUALIZACION) VALUES (1, 1, 1, 1, 1, '2015-11-17');
INSERT INTO VERSION_PROY (ID, ID_PROYECTO, ID_PERSONA, VERSION_MAYOR, VERSION_MENOR, FECHA_ACTUALIZACION) VALUES (2, 1, 2, 1, 3, '2015-11-17');
INSERT INTO VERSION_PROY (ID, ID_PROYECTO, ID_PERSONA, VERSION_MAYOR, VERSION_MENOR, FECHA_ACTUALIZACION) VALUES (3, 1, 1, 1, 4, '2015-11-18');
INSERT INTO VERSION_PROY (ID, ID_PROYECTO, ID_PERSONA, VERSION_MAYOR, VERSION_MENOR, FECHA_ACTUALIZACION) VALUES (4, 2, 5, 0, 5, '2015-11-18');
